...
const APR_LESSONS: Omit<LessonEntry, 'id' | 'createdAt'>[] = [
  ...
  // ─ Tue Apr 14 ─
  { date:d(14), teacherId:'ji',   location:'현진집', startTime:'10:00', type:'individual', students:[{name:'현지',minutes:60,fee:84000}] },
  ...
  { date:d(20), teacherId:'nahee', location:'지하', startTime:'13:30', type:'individual', students:[{name:'소윤',minutes:90,fee:126000}] },
  { date:d(20), teacherId:'nahee', location:'목동', startTime:'21:00', type:'individual', students:[{name:'도윤',minutes:120,fee:168000}] },
  ...
  { date:d(21), teacherId:'shin',  location:'목동', startTime:'21:00', type:'individual', students:[{name:'지우',minutes:120,fee:168000}] },
  { date:d(21), teacherId:'shin',  location:'목동', startTime:'23:00', type:'individual', students:[{name:'한나',minutes:60,fee:84000}] },
  ...
  { date:d(24), teacherId:'yoonsun', location:'지하', startTime:'16:30', type:'individual', students:[{name:'민아',minutes:90,fee:126000}] },
  ...
  { date:d(28), teacherId:'shin',  location:'목동', startTime:'21:00', type:'individual', students:[{name:'지우',minutes:120,fee:168000}] },
  { date:d(28), teacherId:'shin',  location:'목동', startTime:'23:00', type:'individual', students:[{name:'한나',minutes:60,fee:84000}] },
...
const APR_PERSONAL: Omit<PersonalEvent, 'id' | 'createdAt'>[] = [
  // 전주 출장 Apr 3-5
  { date:d(3),  allDay:true,  title:'전주', color:'#14b8a6', startTime:'00:00', endTime:'23:59' },
  { date:d(4),  allDay:true,  title:'전주', color:'#14b8a6', startTime:'00:00', endTime:'23:59' },
  { date:d(5),  allDay:true,  title:'전주', color:'#14b8a6', startTime:'00:00', endTime:'23:59' },
  // 식목일 Apr 5
  ...
  // 일본 Apr 11-12
  { date:d(11), allDay:true,  title:'일본', color:'#3b82f6', startTime:'00:00', endTime:'23:59' },
  { date:d(12), allDay:true,  title:'일본', color:'#3b82f6', startTime:'00:00', endTime:'23:59' },
  // 현진 Apr 14, 25
  ...
  // 전주 출장 Apr 17-18
  { date:d(17), allDay:true,  title:'전주', color:'#14b8a6', startTime:'00:00', endTime:'23:59' },
  { date:d(18), allDay:true,  title:'전주', color:'#14b8a6', startTime:'00:00', endTime:'23:59' },
  // 근로자의 날 May 1
  { date:'2026-05-01', allDay:true, title:'근로자의 날', color:'#ef4444', startTime:'00:00', endTime:'23:59' },
]

export async function seedAprilData() {
  const aprilCount = await db.lessons
    .where('date').between('2026-04-01', '2026-04-30', true, true).count()
  if (aprilCount > 0) return
